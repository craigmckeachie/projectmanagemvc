...
app.controller('ListController',function($scope, $routeParams, dateFilter, ProjectService, ToDoService, UserService){
...
app.controller('ListAddController',function($scope, $routeParams, $location, dateFilter, ProjectService, ToDoService, UserService){
...
app.controller('ListEditController',function($scope, $routeParams, $location, dateFilter, ProjectService, ToDoService, UserService){
...
app.controller('TodoAddController', function($scope, $routeParams, $location, dateFilter, ProjectService, ToDoService, UserService){
...
app.controller('TodoEditController', function($scope, $routeParams, $location, dateFilter, ProjectService, ToDoService, UserService){
...
app.controller('TodoAssignController', function($scope, $routeParams, $location, dateFilter, ProjectService, ToDoService, UserService){
